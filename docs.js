...
var googleDriveLoader = (function() {
  ...
  **/
  ...
  function listFiles(interactive) {
    xhrWithAuth('GET',
                'https://www.googleapis.com/drive/v3/files',
                interactive,
                onListFilesInfoFetched);
  }
  ...
  return {
    onload: function () {
      ...
      xhr_button.addEventListener('click', listFiles.bind(xhr_button, true));
...
window.onload = googleDriveLoader.onload;
